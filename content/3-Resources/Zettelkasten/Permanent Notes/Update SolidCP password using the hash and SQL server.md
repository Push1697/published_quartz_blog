...
#### SQL query to update the dbo.users table
---
```
UPDATE dbo.users
SET password = 'PW+Z4I0tGja/9d1SuoHIVETE6ZP1Mp0AYWuQ5OcALoc='
WHERE username = 'serveradmin';
```
